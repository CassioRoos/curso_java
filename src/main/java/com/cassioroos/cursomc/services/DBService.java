...
public class DBService {
	...
	public void instatiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Cassio Roos", "cassio.roos+teste@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("teste"));
		...
		Cliente cli2 = new Cliente(null, "Marieta Costeleta", "cassio.roos+testes@gmail.com", "00654984026", TipoCliente.PESSOAFISICA, pe.encode("teste"));

		cli2.getTelefones().addAll(Arrays.asList("99156151", "546518641"));
		cli2.addPerfil(Perfil.ADMIN);
		
		Endereco e3 = new Endereco(null, "Servidão Sofrimento", "9900", null, "Macegal", "9283533", cli2, c1);
