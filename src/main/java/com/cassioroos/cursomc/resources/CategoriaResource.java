...
import com.cassioroos.cursomc.services.CategoriaService;
...
public class CategoriaResource {
	...
	public ResponseEntity<Void> update(@Valid @RequestBody CategoriaDTO objDTO, @PathVariable Integer cod) {
		Categoria obj = service.fromDTO(objDTO);
		obj.setId(cod);
		service.update(obj);
