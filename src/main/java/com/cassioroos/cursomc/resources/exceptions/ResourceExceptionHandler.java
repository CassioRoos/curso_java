package com.cassioroos.cursomc.resources.exceptions;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> objectNotFount(DataIntegrityException e, HttpServletRequest request){
	...
	public ResponseEntity<StandardError> objectNotFount(MethodArgumentNotValidException e, HttpServletRequest request){
